import { createConsoleClient } from './node_modules/@circle-fin/developer-controlled-wallets/dist/developer-controlled-wallets.es.js';
...
async function initialize() {
  console.log('--- Initializing Circle Treasury Account (JS) ---');
