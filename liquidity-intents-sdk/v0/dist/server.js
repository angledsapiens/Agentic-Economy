...
const resolver = new resolver_1.CapabilityResolver(process.env.TESTNET_RPC_URL || 'https://sepolia.base.org', process.env.REGISTRY_ADDRESS // Optional: Set in .env if deployed
);
// --- Endpoints ---
