...
const REGISTRY_ABI = [
    ...
    "function getAgentsByCapability(string memory _capability) public view returns (tuple(address walletAddress, string capability, uint256 minPrice)[])",
    "event AgentRegistered(address indexed agent, string capability, uint256 minPrice)"
];
    ...
    async getAgents(capability) {
        ...
        try {
            ...
            return agents.map((a) => ({
                ...
                minPrice: ethers_1.ethers.formatUnits(a.minPrice, "wei") // Return as string
            }));
        }
        catch (error) {
